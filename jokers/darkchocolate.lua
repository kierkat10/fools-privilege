...
SMODS.Joker{ --Dark Chocolate
    ...
    loc_vars = function(self, info_queue, card)
        ...
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds, 'j_foolspri_darkchocolate') 
        ...
        if context.cardarea == G.jokers and context.joker_main  then
            if true then
                return {
                    ...
                    ,
                    func = function()
                        if SMODS.pseudorandom_probability(card, 'group_0_53433959', 1, card.ability.extra.odds, 'j_foolspri_darkchocolate', false) then
