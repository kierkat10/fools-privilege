...
SMODS.Joker{ --Red Velvet Cake
    ...
    loc_txt = {
        ...
        ['text'] = {
            [1] = 'Scored {C:hearts}Hearts{} give {C:red}+4{} Mult',
    ...
    loc_vars = function(self, info_queue, card)
        ...
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds, 'j_foolspri_redvelvetcake') 
    ...
    calculate = function(self, card, context)
        ...
        if context.end_of_round and context.game_over == false and context.main_eval  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_ecd9e8f0', 1, card.ability.extra.odds, 'j_foolspri_redvelvetcake', false) then
