...
SMODS.Joker{ --Sashimi
    ...
    loc_vars = function(self, info_queue, card)
        ...
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds, 'j_foolspri_sashimi') 
    ...
    calculate = function(self, card, context)
        ...
        if context.pre_discard  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_6069a3fb', 1, card.ability.extra.odds, 'j_foolspri_sashimi', true) then
