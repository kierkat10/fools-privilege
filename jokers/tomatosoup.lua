...
SMODS.Joker{ --Tomato Soup
    ...
    loc_vars = function(self, info_queue, card)
        ...
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds, 'j_foolspri_tomatosoup') 
    ...
    calculate = function(self, card, context)
        if context.cardarea == G.jokers and context.joker_main  then
            ...
            elseif true then
                if SMODS.pseudorandom_probability(card, 'group_0_fd0c875b', 1, card.ability.extra.odds, 'j_foolspri_tomatosoup', false) then
